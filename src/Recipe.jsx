                            ...
                            <div key={recipe._id} className="col-md-4 col-sm-6 col-xs-12">
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">{recipe.ingredients.length > 180 ? `${recipe.ingredients.slice(0, 180)}...` : recipe.ingredients}</p>

                                        {/* <p className="card-text-desc">{recipe.description}</p> */}
                                        <Link to={`/recipe/${recipe._id}`} className="btn btn-dark">Watch More</Link>
