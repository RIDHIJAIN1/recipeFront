  ...
  return loading ? (
    ...
    <div className="App">
            ...
            <div>
              <div className="box">
                <div className="image fit">
                  <img src={image4} alt="" width="600" height="300" />
                </div>
                <div className="content">
                  ...
                  <footer className="align-center">
                    <Link
                      to="/recipe/65f2ff221e303ef4e36278b6"
      ...
      <section id="three" className="wrapper style2">
        <div className="inner">
          <header className="align-center">
            <p className="special">Where Every Bite Tells a Story</p>
            <h2>DelishDomain</h2>
          </header>
          <div className="gallery">
            <div>
              <div className="image fit">
                <a href="#">
                  <img src={image5} alt="" width="600" height="300" />
                </a>
              </div>
            </div>
            <div>
              <div className="image fit">
                <a href="#">
                  <img src={image6} alt="" width="600" height="300" />
                </a>
              </div>
            </div>
            <div>
              <div className="image fit">
                <a href="#">
                  <img src={image7} alt="" width="600" height="300" />
                </a>
              </div>
            </div>
            <div>
              <div className="image fit">
                <a href="#">
                  <img src={image8} alt="" width="600" height="300" />
                </a>
              </div>
            </div>
          </div>
